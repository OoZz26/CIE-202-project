...
void Triangle::Draw(GUI* pUI) const
{
	...
	cout << "TRIANGLEEEEEEEE" << endl;
	cout << Corner1.x << " " << Corner2.x << " " << endl;
 
	cout <<"colors are" << to_string(ShpGfxInfo.DrawClr.ucBlue) << " , " << to_string(ShpGfxInfo.DrawClr.ucGreen)<< " , " << to_string(ShpGfxInfo.DrawClr.ucRed) << endl;
	//Call Output::DrawTri to draw a Triangle on the screen	
	pUI->DrawTri(Corner1, Corner2,Corner3, ShpGfxInfo, Hidden, unhidden, duplicated);
}
